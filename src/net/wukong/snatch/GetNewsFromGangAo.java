...
public class GetNewsFromGangAo implements DataTransfer {
	
	
	public String getGangAo() throws IOException {//static void main(String[] args) throws IOException {// 
		String gangAoUrl = null;
		for(int i=1;i<=2;i++){
			if(i==1){
				gangAoUrl = "http://news.baidu.com/n?cmd=4&class=gangaotai=1";
			}if(i==2){
				gangAoUrl = "http://news.baidu.com/n?cmd=4&class=gangaotai=2&sub=0";
			}
